# Imported from the python github repository 2024-01-29
# https://github.com/python/cpython/blob/main/Parser/asdl.py
#
# Also see "Wang, Appel, Korn, Serra. The Zephyr Abstract Syntax Description Language.
# DSL'97" (https://www.cs.princeton.edu/~appel/papers/asdl97.pdf)
